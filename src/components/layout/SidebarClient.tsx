        ...
        {isAdmin && (
          <>
            <div className={`pt-4 pb-1 ${collapsed ? 'px-0 text-center' : 'px-3'}`}>
              <span className={`text-[10px] uppercase tracking-widest text-slate-600 font-bold transition-opacity ${collapsed ? 'opacity-0 hidden' : 'opacity-100'}`}>{translations.sidebar.admin}</span>
